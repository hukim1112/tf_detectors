...
model_dir = os.path.join("experiments/large_Pedestrian_EfficientSSD", datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
...
model = EfficientSSD300(len(val_dataset.coco_labels_inverse))
